...
\section{Setting}
\label{sec:orgc070d19}
\begin{frame}[label={sec:org1517c77}]{Disclaimer}
\begin{itemize}[<+->]
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org918a43a}]{A statistical problem}
...
\begin{frame}[label={sec:org185c180}]{Target and nuisance parameters}
\begin{description}
...
\begin{frame}[label={sec:org2a6cd8f}]{High-/infinite-dimensional nuisance parameters}
...
\section{Motivation}
\label{sec:org3f07774}
\begin{frame}[label={sec:org3c157ad}]{Toy example: Integrated kernel density}
...
\begin{frame}[label={sec:org9ee9b87}]{How does this work in practice?}
\pause
\begin{center}
...
\begin{frame}[label={sec:orgd31e06c}]{What happened?}
\pause
...
\begin{frame}[label={sec:orgfd3000d}]{What to do?  -- Taylor expansion}
\pause
