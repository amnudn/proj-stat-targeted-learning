...
\section{Setting}
\label{sec:org2761eac}
\begin{frame}[label={sec:org04ad39a}]{Disclaimer}
\begin{itemize}[<+->]
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgbf9b283}]{A statistical problem}
...
\begin{frame}[label={sec:orgadab1c9}]{Target and nuisance parameters}
\begin{description}
...
\begin{frame}[label={sec:orge94a9d6}]{High-/infinite-dimensional nuisance parameters}
...
\section{Motivation}
\label{sec:orgfd05f87}
\begin{frame}[label={sec:org0b18ae0}]{Toy example: Integrated kernel density}
...
\begin{frame}[label={sec:org5088814}]{How does this work in practice?}
\pause
\begin{center}
...
\begin{frame}[label={sec:org3075588}]{What happened?}
\pause
...
\begin{frame}[label={sec:org918c166}]{What to do?  -- Taylor expansion}
\pause
