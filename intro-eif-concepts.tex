...
\fxnote*{vdVaart?}{(ref)}. The function $\ic$ is referred to as the \textit{influence function} of
...
\fxnote[inline, nomargin]{... Connect both gradient and IF, or just \textit{canonical} and
  \textit{efficient} IF?... Maybe both and then just say ``under regularity conditions''...?}
