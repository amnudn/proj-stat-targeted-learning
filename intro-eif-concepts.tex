...
\begin{proof}
  The \fxnote*{Combine this and next remark into a proof sketch}{chain rule for Hadamard derivative}
...
\fxnote*{Maybe simplify this simply to the statement that the EIF fulfills the N-O condition and
  then have the N-O as a proper def earlier? }{}
